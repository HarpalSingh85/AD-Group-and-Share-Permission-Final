...
namespace ADGroupsCreator
{
    public partial class mainForm : Form
    {
        ...
        private void ImageProceed()
        {
            statusLbl.Visible = true;
            statusLbl.Image = new Bitmap(ADGroupsCreator.Properties.Resources.Processing);
            statusLbl.ImageAlign = ContentAlignment.MiddleRight;
        }
        ...
        private void BtnNext_Click(object sender, EventArgs e)
        {
            ...
            txtBoxpnBShare.Text = txtBoxShare.Text.ToUpper();
                ...
                if (!String.IsNullOrWhiteSpace(txtBoxGroupName.Text))
                {
                    ...
                    catch (Exception ex)
                    {
                        if (ex is DirectoryNotFoundException)
                        {
                            ...
                            btnApplyPermission.Enabled = true;
        ...
        private void Newperms_PermTaskError(object source, EventArgs e)
        {
        ...
        {
            if (statusLbl.ForeColor == Color.Black)
            {
                statusLbl.Visible = true;
                ImageProceed();
                statusLbl.ForeColor = Color.FromArgb(48, 48, 48);
        ...
        private void stopapplyPermissionanimation()
        {
            t1.Stop();
            t1.Enabled = false;
            statusLbl.ForeColor = Color.Black;
